...
const DiscountDialogBox = ({ StyledListItem }) => {
  ...
  return (
    <div>
      <StyledListItem onClick={handleOpenDiscountDialog}>Add Discount</StyledListItem>
      <Dialog
      ...
      >
        ...
        <DialogTitle sx={{ m: 0, p: 1.5 }}>
          <Typography sx={{ fontWeight: 600, fontSize: "15px", color: "#091B29" }}>Add Discount to Unit</Typography>
          <IconButton
            aria-label="close"
